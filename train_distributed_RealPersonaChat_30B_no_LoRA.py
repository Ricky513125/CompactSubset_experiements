...
def main():
    parser = argparse.ArgumentParser(description='分布式消融实验训练（FlashAttention 2 + 动态Padding）- RealPersonaChat')
    parser.add_argument('--config', type=str,
                       default='config_RealPersonaChat.json',
                       help='配置文件路径')
    ...
    parser.add_argument('--wandb_project', type=str, default='Qwen3-RealPersonaChat',
                       help='Weights & Biases项目名称（默认：Qwen3-RealPersonaChat）')
