...
run_training "Chameleons" 29502 \
    ...
    --output_dir outputs/Chameleons_Gemma_context \
    --max_epochs 50 \
    --val_ratio 0.1 \
    --wandb_project Gemma3_27B-Chameleons \
    --wandb_run_name context \
    --prompt_style simple
...
run_training "LovinkDialogue" 29510 \
    ...
    --output_dir outputs/LovinkDialogue_Gemma_profile_context \
    --max_epochs 50 \
    --val_ratio 0.1 \
    --wandb_project Gemma3_27B-LovinkDialogue \
    --wandb_run_name profile_context \
    --prompt_style simple
...
run_training "LovinkQuestionnaire" 29515 \
    ...
    --output_dir outputs/LovinkQuestionnaire_Gemma_history_random \
    --max_epochs 50 \
    --val_ratio 0.1 \
    --history_strategy random \
    --history_ratio 0.9 \
    --wandb_project Gemma3_27B-LovinkQuestionnaire \
    --wandb_run_name history_random \
    --prompt_style simple
