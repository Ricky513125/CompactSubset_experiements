...
run_training "Chameleons" 29502 \
    ...
    --output_dir outputs/Chameleons_8B_context_sampled_seed42 \
    --max_epochs 50 \
    --val_ratio 0.1 \
    --wandb_project Qwen3_8B-Chameleons \
...
run_inference "Chameleons" 29502 \
    ...
    Chameleons \
    context_only \
    outputs/leaderboards/Chameleons_8B_context_sampled_seed42

delete_model outputs/Chameleons_8B_context_sampled_seed42 "Chameleons"
...
run_inference "DMSC" 29505 \
    ...
    DMSC \
    profile_and_history \
    outputs/leaderboards/DMSC_8B_one_per_user_0213

delete_model outputs/DMSC_8B_one_per_user_0213 "DMSC"
...
run_training "LovinkDialogue" 29510 \
    ...
    --output_dir outputs/LovinkDialogue_8B_profile_context_sampled_seed42 \
    --max_epochs 50 \
    --val_ratio 0.1 \
...
run_inference "LovinkDialogue" 29510 \
    outputs/LovinkDialogue_8B_profile_context_sampled_seed42 \
    LovinkDialogue \
    profile_and_context \
    outputs/leaderboards/LovinkDialogue_8B_profile_context_sampled_seed42

delete_model outputs/LovinkDialogue_8B_profile_context_sampled_seed42 "LovinkDialogue"
...
run_training "LovinkQuestionnaire" 29515 \
    ...
    --output_dir outputs/LovinkQuestionnaire_8B_history_random_sampled_seed42 \
    --max_epochs 50 \
    --val_ratio 0.1 \
...
run_inference "LovinkQuestionnaire" 29515 \
    outputs/LovinkQuestionnaire_8B_history_random_sampled_seed42 \
    LovinkQuestionnaire \
    history_only \
    outputs/leaderboards/LovinkQuestionnaire_8B_history_random_sampled_seed42

delete_model outputs/LovinkQuestionnaire_8B_history_random_sampled_seed42 "LovinkQuestionnaire"
...
run_inference "MovieLens" 29520 \
    outputs/MovieLens_8B_history_random_targets_seed42 \
    MovieLens \
    history_only \
    outputs/leaderboards/MovieLens_8B_history_random_targets_seed42

delete_model outputs/MovieLens_8B_history_random_targets_seed42 "MovieLens"
...
run_inference "PERSONA_Bench" 29525 \
    outputs/PERSONA_Bench_8B_history_context_sampled_seed42 \
    PERSONA_Bench \
    history_and_context \
    outputs/leaderboards/PERSONA_Bench_8B_history_context_sampled_seed42

delete_model outputs/PERSONA_Bench_8B_history_context_sampled_seed42 "PERSONA_Bench"
...
run_inference "RealPersonaChat" 29530 \
    outputs/RealPersonaChat_8B_profile_context_sampled_seed42 \
    RealPersonaChat \
    profile_and_context \
    outputs/leaderboards/RealPersonaChat_8B_profile_context_sampled_seed42

delete_model outputs/RealPersonaChat_8B_profile_context_sampled_seed42 "RealPersonaChat"
...
run_inference "REALTALK" 29535 \
    outputs/REALTALK_8B_context_sampled_seed42 \
    REALTALK \
    context_only \
    outputs/leaderboards/REALTALK_8B_context_sampled_seed42

delete_model outputs/REALTALK_8B_context_sampled_seed42 "REALTALK"
