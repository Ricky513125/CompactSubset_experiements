...
def main():
    parser = argparse.ArgumentParser(description='分布式消融实验训练（FlashAttention 2 + 动态Padding）- DMSC')
    parser.add_argument('--config', type=str,
                       default='config_DMSC.json',
                       help='配置文件路径')
    ...
    parser.add_argument('--wandb_project', type=str, default='Qwen3-DMSC',
                       help='Weights & Biases项目名称（默认：Qwen3-DMSC）')
